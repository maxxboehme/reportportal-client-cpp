...
//    launch.set_attributes(attributs);
    ...
    launch.start(std::chrono::high_resolution_clock::now());
    {
        ...
        suite.start(std::chrono::high_resolution_clock::now());
        {
            ...
            test.start(std::chrono::high_resolution_clock::now());
            {
                ...
                step.start(std::chrono::high_resolution_clock::now());

                step.log(std::chrono::high_resolution_clock::now(), report_portal::log_level::info, "REQUIRE(result == actual)");
                step.log(std::chrono::high_resolution_clock::now(), report_portal::log_level::info, "this is another log");
                step.log(std::chrono::high_resolution_clock::now(), report_portal::log_level::info, "and another");

                step.end(std::chrono::high_resolution_clock::now(), report_portal::test_item_status::passed);
            }
...
//
//                scenario.start(std::chrono::high_resolution_clock::now());
//                scenario.end(std::chrono::high_resolution_clock::now(), report_portal::test_item_status::passed);
//            }
//
//            test.end(std::chrono::high_resolution_clock::now());
//        }
...
//
//            test.start(std::chrono::high_resolution_clock::now());
//            test.end(std::chrono::high_resolution_clock::now(), report_portal::test_item_status::stopped);
//        }
//        {
...
//
//            test.start(std::chrono::high_resolution_clock::now());
//            test.end(std::chrono::high_resolution_clock::now(), report_portal::test_item_status::skipped);
//        }
//        {
...
//
//            test.start(std::chrono::high_resolution_clock::now());
//            test.end(std::chrono::high_resolution_clock::now(), report_portal::test_item_status::interrupted);
//        }
//        {
...
//
//            test.start(std::chrono::high_resolution_clock::now());
//            test.end(std::chrono::high_resolution_clock::now(), report_portal::test_item_status::cancelled);
//        }
